...
class DB {
    ...
    initDb() {
      ...
      this._con.query("CREATE TABLE users (user_id INT AUTO_INCREMENT PRIMARY KEY, full_name VARCHAR(255), email VARCHAR(320), hashed_password VARCHAR(255), organization_id INT, organization_permission ENUM('admin', 'owner', 'member'))")
